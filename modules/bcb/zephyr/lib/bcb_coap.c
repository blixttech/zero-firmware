...
static struct bcb_coap_data bcb_coap_data = {
    .resources = {
        ...
        {   .get = bcb_coap_handlers_tc_def_get,
            .post = bcb_coap_handlers_tc_def_post,
            .user_data = &((struct coap_core_metadata){
                            .attributes = BCB_COAP_RESOURCE_TC_DEF_ATTRIBUTES,
                        }),
            .path = BCB_COAP_RESOURCE_TC_DEF_PATH,
        },
        {   .get = bcb_coap_handlers_tc_get,
            .post = bcb_coap_handlers_tc_post,
            .user_data = &((struct coap_core_metadata){
                            .attributes = BCB_COAP_RESOURCE_TC_ATTRIBUTES,
                        }),
