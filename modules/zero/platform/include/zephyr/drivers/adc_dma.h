...
enum adc_dma_sampling_mode {
	ADC_DMA_SAMPLING_MODE_SINGLE,
	ADC_DMA_SAMPLING_MODE_CONTINUOUS,
};
 ...
 */
typedef void (*adc_dma_seq_callback)(const struct device *dev, void *buffer, size_t buffer_size);
